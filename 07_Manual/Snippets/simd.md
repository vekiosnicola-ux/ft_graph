...
```h
 ...
 !defined(NO_SIMD) && defined(__AVX512F__) && defined(__AVX512BW__)
 <immintrin.h>
 <nmmintrin.h>
 simd_vector_from_mask(a)   _mm512_movm_epi8(a)
 simd_imask_from_mask(a)    _cvtmask64_u64(a)
 simd_set_i8(a)             _mm512_set1_epi8(a)
 simd_setzero()             _mm512_setzero_si512()
 simd_cmpeq_i8_mask(a, b)   _mm512_cmpeq_epi8_mask((a), (b))
 simd_andnot_i8(a, b)       _mm512_andnot_si512((a), (b))
 simd_add_i64(a, b)         _mm512_add_epi64((a), (b))
 simd_sub_i8(a, b)          _mm512_sub_epi8((a), (b))
 simd_sad_u8(a, b)          _mm512_sad_epu8((a), (b))
 simd_imask_popcnt(a)       _mm_popcnt_u64(a)
 simd_cmpeq_i8(a, b)        simd_vector_from_mask(simd_cmpeq_i8_mask((a), (b)))
 simd_cmpws_i8(a)           simd_vector_from_mask(simd_cmpws_i8_mask(a))
 simd_store(a, b)          _mm512_store_si512((a), (b))
...
// endif AVX512
 !defined(NO_SIMD) && defined(__AVX2__)
 <immintrin.h>
 <nmmintrin.h>
 simd_vector_from_mask(a)  (a)
 simd_imask_from_mask(a)   _mm256_movemask_epi8(a)
 simd_set_i8(a)            _mm256_set1_epi8(a)
 simd_setzero()            _mm256_setzero_si256()
 simd_cmpeq_i8(a, b)       _mm256_cmpeq_epi8((a), (b))
 simd_andnot_i8(a, b)      _mm256_andnot_si256((a), (b))
 simd_add_i64(a, b)        _mm256_add_epi64((a), (b))
 simd_sub_i8(a, b)         _mm256_sub_epi8((a), (b))
 simd_sad_u8(a, b)         _mm256_sad_epu8((a), (b))
 simd_imask_popcnt(a)      _mm_popcnt_u32(a)
 simd_cmpeq_i8_mask(a, b)  simd_cmpeq_i8((a), (b))
 simd_cmpws_i8_mask(a)     simd_cmpws_i8(a)
 simd_store(a, b)          _mm256_store_si256((a), (b))
...
// endif AVX2
 !defined(NO_SIMD) && (defined(__SSE2__) || defined(_M_X64) || _M_IX86_FP == 2)
 <emmintrin.h>
 <immintrin.h>
 <nmmintrin.h>
 <tmmintrin.h>
 simd_vector_from_mask(a)  (a)
 simd_imask_from_mask(a)   _mm_movemask_epi8(a)
 simd_set_i8(a)            _mm_set1_epi8(a)
 simd_setzero()            _mm_setzero_si128()
 simd_cmpeq_i8(a, b)       _mm_cmpeq_epi8((a), (b))
 simd_andnot_i8(a, b)      _mm_andnot_si128((a), (b))
 simd_add_i64(a, b)        _mm_add_epi64((a), (b))
 simd_sub_i8(a, b)         _mm_sub_epi8((a), (b))
 simd_sad_u8(a, b)         _mm_sad_epu8((a), (b))
 simd_cmpeq_i8_mask(a, b)  simd_cmpeq_i8((a), (b))
 simd_cmpws_i8_mask(a)     simd_cmpws_i8(a)
 simd_store(a, b)          _mm_store_si128((a), (b))
 defined(__AVX__) || defined(__POPCNT__)
 simd_imask_popcnt(a)      _mm_popcnt_u32((simd_imask)(a))
...
static inline simd_vector simd_cmpws_i8(simd_vector a)
{
 defined(__AVX__) || defined(__SSSE3__)
...
//endif defined(NO_SIMD)
 defined(SIMD_USE_POPCNT) && defined(simd_imask_popcnt)
